    ...
    <article>
      ...
      >
        ...
        <div className="container-tight pb-16 pt-32">
          <Link
            href="/services"
            className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.28em] text-foreground/70 transition-colors hover:text-foreground"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl text-pretty text-base text-foreground/80 sm:text-lg"
          >
