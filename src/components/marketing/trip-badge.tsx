...
export function TripBadge() {
  ...
  return (
    <Link
      href="/trip"
      className="group relative inline-flex items-center gap-2 rounded-full border border-current/30 px-4 py-2 text-xs uppercase tracking-[0.2em] transition-colors hover:border-accent hover:text-accent"
      aria-label={t("trip")}
    >
